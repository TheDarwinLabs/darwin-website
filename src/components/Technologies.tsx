    ...
    <div className="flex flex-col mx-auto pt-[50px] pb-[78px] sm:justify-between sm:flex-row sm:w-[1200px] sm:h-[900px] sm:px-0 sm:pt-[171px] sm:pb-0">
      ...
      <div className="hidden pr-[100px] pt-[60px] sm:flex flex-col gap-[60px]">
        {list.map((item, index) => (
          ...
          >
            <SvgIcon name="technology-sm" className=" w-[48px] h-[48px]" />
      ...
      <div className="flex items-center mt-[30px] w-full h-full gap-[30px] overflow-x-auto overflow-y-hidden whitespace-nowrap scrollbar-none px-5 sm:hidden">
        {list.map((item, index) => (
          <div
            key={index}
            className="technology-item-sm min-w-[260px] p-[30px]"
          >
