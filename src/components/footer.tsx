      ...
      <div className="self-stretch flex-col md:flex-row gap-3 md:justify-between items-end inline-flex">
        <div className="flex-col justify-end items-start  ">
          ...
          <div className="w-full md:w-[370px] text-[#757575] text-xs leading-[17px] ">
            ...
            fully understand how the Protocol works. As described in our Terms,
            Darwin Protocol is provided on an “as is” and “as available” basis,
            at your own risk. Use of the Darwin Protocol involves risks,
            including but not limited to the potential loss of digital assets.
            Nothing in Darwin Protocol is intended to be construed as a
            solicitation of any individual in restricted jurisdictions. We
            explicitly disclaim any representation or warranties of any kind
            relating to the Protocol or usage of the Protocol, and no developer
            or entity will be liable for claims or damages of any kind
