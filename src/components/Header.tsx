...
const Header = () => {
  ...
  return (
    <div
      className={cn(
        "bg-[rgba(11,8,13,0.8)] fixed left-0 right-0 top-0 z-50  sm:fixed  transition-all duration-300",
        scrollY > 1 ? "backdrop-blur-xl" : ""
      )}
    >
      <div
        className={cn(
          " relative mx-auto px-[15px] py-[18px] flex items-center justify-between sm:w-[1200px] sm:px-[40px] sm:py-[30px] "
        )}
      >
        <SvgIcon
          name="logo_header"
